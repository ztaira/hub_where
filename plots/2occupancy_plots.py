...
def plot_station_locations_and_occupancy(station_coords, station_occupancies):
    ...
    # for size
    plt.figure()
    station_occupancies_scaled = [2000*x**2 for x in station_occupancies]
    plt.scatter(station_coords[2], station_coords[1], s=station_occupancies_scaled)
    plt.title("Hubway Stations by GPS Coordinates and Average Occupancy (Size)")
    ...
    plt.title("Hubway Stations by GPS Coordinates and Average Occupancy (Color)")
    plt.xlabel("Longitude")
    plt.ylabel("Latitude")
    plt.gca().set_aspect('equal', adjustable='box')
    ...
    plt.title("Hubway Stations by GPS Coordinates and Average Occupancy (Size and Color)")
    plt.xlabel("Longitude")
    plt.ylabel("Latitude")
    plt.gca().set_aspect('equal', adjustable='box')
